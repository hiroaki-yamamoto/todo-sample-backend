...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewTodo2githubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐNewTodo)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) field_Mutation_updateTodo_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNUpdateTodo2githubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐUpdateTodo)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTodo2ᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐTodo,
		true,
		true,
	)
}
...
func (ec *executionContext) _Todo_user(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNUser2ᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐUser,
		true,
		true,
	)
}
...
func (ec *executionContext) unmarshalInputUpdateTodo(ctx context.Context, obj any) (model.UpdateTodo, error) {
	...
	fieldsInOrder := [...]string{"id", "text", "wipAt", "completedAt"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "text":
			...
			it.Text = data
		case "wipAt":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("wipAt"))
...
func (ec *executionContext) unmarshalNNewTodo2githubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐNewTodo(ctx context.Context, v any) (model.NewTodo, error) {
...
func (ec *executionContext) marshalNTodo2githubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v model.Todo) graphql.Marshaler {
	return ec._Todo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTodo2ᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateTodo2githubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐUpdateTodo(ctx context.Context, v any) (model.UpdateTodo, error) {
	res, err := ec.unmarshalInputUpdateTodo(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOTodo2ᚕᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐTodoᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTodo2ᚖgithubᚗcomᚋhiroakiᚑyamamotoᚋtodoᚑsampleᚑbackendᚋgraphᚋmodelᚐTodo(ctx, sel, v[i])
	})
